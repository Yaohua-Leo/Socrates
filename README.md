...
The current codebase is a v0.37-alpha prototype. Its strongest surfaces are the
...
long-term report-surface refresh, dry-run-previewable structured batch-refreshable commands-output command-summarized filterable readiness-counted
