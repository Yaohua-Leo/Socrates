...
- Current implementation baseline: v0.26-alpha read-only study brief status
  command, over v0.25 manifest-backed study brief freshness, v0.24 study brief
  next-action freshness visibility, v0.23
