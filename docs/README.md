...
- Current implementation baseline: v0.15-alpha recommended focus summaries in
  reports, over v0.14 priority action snapshots, v0.13 priority action queue
  navigation, and v0.12 workflow action queue visibility
