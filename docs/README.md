...
- Current implementation baseline: v0.33-alpha command-summarized filterable
  readiness-counted machine-readable read-only multi-project resume indexes, over v0.32
